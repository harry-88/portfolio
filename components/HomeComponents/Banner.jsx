    ...
    return (
        <BannerLayout>
            <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack">
                                    ...
                                    {/* <span>{"<"}<span className="text-Green sm:text-base xl:text-lg font-bold">div</span> */}
                                        ...
                                        <span className="text-Snow sm:text-xl xl:text-2xl font-bold"> I am a  <span className="inline-block">
                                            <Typewriter
                                                options={{
                                                    strings:
                                                        ['Full Stack Developer','JavaScript Developer', 'Next JS Developer', 'Node JS Developer',
                                                            'Specializing in Building Projects from Scratch'],
                                                    autoStart: true,
                                                    loop: true,
                                                }}
                                            />
                                         ...
                                         {/* {"</"}<span className="text-Green sm:text-base xl:text-lg font-bold">div</span>{">"} </span> */}
                                </div>
                            </div>
                ...
                {/* details in row */}
                <div className="grid grid-cols-2 gap-4 md:gap-0 md:flex items-center justify-start mx-4 w-full px-4 xl:px-8 2xl:px-16">
